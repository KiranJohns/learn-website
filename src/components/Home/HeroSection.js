                            ...
                            <div className="row align-items-center">
                                <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    ...
                                    <h3 className="hero__title">
                                        ...
                                        social care  courses</h3>
                                      
                                        <p>Empowering efficient compliance management, Restoring your control.</p>
                                ...
                                <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    ...
                                    <div className="hero__thumb-big mr-30">
                                        <img src="assets/img/hero/hero1112.webp" alt="img not found"/>
                                    ...
                                    <div className="hero__thumb-sm mt-50 d-none d-lg-block">
                                        <img src="assets/img/hero/hero-sm-2.webp" alt="img not found"/>
                                    </div>
                                    </div>
                                </div>
                            </div>
