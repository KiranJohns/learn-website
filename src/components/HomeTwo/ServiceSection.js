               ...
               <div className="row">
                  ...
                  <Link href="/all-courses">
                     <div className="services__item blue-bg-4 mb-30">
                        ...
                        <div className="services__content">
                           <h5 className="services__title"><a>50+ <br /> Online courses</a></h5>
                  ...
                  <Link href="/all-courses">
                     <div className="services__item pink-bg mb-30">
                        ...
                        <div className="services__content">
                           <h5 className="services__title"><a>Learn<br/>at your own pace<br /></a></h5>
                           {/* <p>Arhje over  morish wind up gormless buttlyl.!</p> */}
                  ...
                  <div   onClick={() => {
                     ...
                     <div className="services__item purple-bg mb-30">
                        ...
                        <div className="services__content">
                           <h5 className="services__title"><a>Easy<br /> to monitor</a></h5>
                           {/* <p>Arhje over  morish wind up gormless buttlyl.!</p> */}
                  ...
                  <Link href="/all-courses">
                     <div className="services__item green-bg mb-30">
                        ...
                        <div className="services__content">
                           <h5 className="services__title"><a>Certificated <br/>courses</a></h5>
                           {/* <p>Arhje over  morish wind up gormless buttlyl.!</p> */}
